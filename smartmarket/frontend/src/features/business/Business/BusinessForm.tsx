...
//   const [type, setBusinessType] = useState('');
...
//           {/* <!-- Heading --> */}
//           <h2 className="my-5 text-center title">Business form</h2>
...
//   type="button"
//   onClick={() => mutation.mutate({ name, businessEmail, type, address, address2, desc, county, zip })}
// >
//   Submit
// </button>
